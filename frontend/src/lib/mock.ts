import type { Index, Stock, NewsItem, TechnicalAnalysis, Mover, Candle } from '@/types';

export const MOCK_INDICES: Index[] = [
  { code: "KOSPI", name: "코스피", value: 2847.32, change: 18.46, changePct: 0.65, volume: "8.2조", high: 2851.04, low: 2828.87, spark: [2810, 2815, 2808, 2820, 2825, 2818, 2830, 2835, 2828, 2840, 2845, 2847] },
  { code: "KOSDAQ", name: "코스닥", value: 845.91, change: -4.23, changePct: -0.50, volume: "6.8조", high: 852.14, low: 843.77, spark: [855, 853, 850, 852, 848, 847, 846, 849, 847, 846, 844, 845] },
  { code: "KOSPI200", name: "코스피200", value: 384.21, change: 2.18, changePct: 0.57, volume: "—", high: 385.02, low: 381.94, spark: [378, 379, 378, 380, 381, 380, 382, 383, 382, 383, 384, 384] },
  { code: "KRW", name: "원/달러", value: 1382.40, change: -3.20, changePct: -0.23, volume: "—", high: 1387.10, low: 1380.50, spark: [1390, 1388, 1389, 1386, 1385, 1387, 1384, 1383, 1385, 1383, 1382, 1382] },
];
...
export const MOCK_MARKET_NEWS: NewsItem[] = [
  { id: 1, category: "시장", title: "코스피, 외국인 매수에 8거래일 연속 상승…2,847선 마감", source: "한국경제", time: "14:32", impact: "긍정", summary: "외국인이 7,200억원 순매수하며 코스피를 끌어올렸다. 반도체·바이오 업종이 상승을 주도했다.", url: "https://n.news.naver.com/mnews/article/015/0005123456" },
  { id: 2, category: "기업", title: "삼성전자, HBM4 양산 일정 6개월 앞당겨…엔비디아 공급 확대", source: "전자신문", time: "13:18", impact: "긍정", summary: "차세대 고대역폭메모리 양산이 당초 계획보다 빨라지며 AI 메모리 시장 주도권 확보 기대.", url: "https://n.news.naver.com/mnews/article/030/0005234567" },
  { id: 3, category: "정책", title: "한은, 5월 금통위서 기준금리 동결 가능성…환율 변수", source: "연합뉴스", time: "12:45", impact: "중립", summary: "물가 둔화에도 원/달러 환율 부담이 커지면서 인하 시점이 6월 이후로 미뤄질 것이라는 분석.", url: "https://n.news.naver.com/mnews/article/001/0005345678" },
  { id: 4, category: "글로벌", title: "美 4월 CPI 예상치 부합…나스닥 0.8% 상승 마감", source: "블룸버그", time: "08:12", impact: "긍정", summary: "근원 CPI가 전월 대비 0.3% 상승하며 시장 전망에 부합. 연내 금리 인하 기대 유지.", url: "https://n.news.naver.com/mnews/article/025/0005456789" },
  { id: 5, category: "기업", title: "현대차·기아 4월 美 판매 14.2% 증가…전기차 호조", source: "머니투데이", time: "10:24", impact: "긍정", summary: "아이오닉5·EV6 등 전기차 판매가 전년 대비 38% 늘어나며 분기 실적 호조 전망.", url: "https://n.news.naver.com/mnews/article/008/0005567890" },
  { id: 6, category: "시장", title: "코스닥, 바이오 차익실현에 사흘 연속 약세", source: "이데일리", time: "15:05", impact: "부정", summary: "최근 급등했던 바이오 종목 중심 매도세. 시총 상위주 평균 1.2% 하락.", url: "https://n.news.naver.com/mnews/article/018/0005678901" },
];

export const MOCK_STOCK_NEWS: Record<string, NewsItem[]> = {
  "005930": [
    { title: "삼성전자, HBM4 양산 일정 6개월 앞당겨…엔비디아 공급 확대", source: "전자신문", time: "13:18", impact: "긍정", url: "https://n.news.naver.com/mnews/article/030/0005234567" },
    { title: "갤럭시 S26 시리즈, 자체 AI 칩 탑재 검토", source: "조선비즈", time: "11:02", impact: "긍정", url: "https://n.news.naver.com/mnews/article/047/0005112233" },
    { title: "외국인, 삼성전자 9거래일 연속 순매수", source: "한국경제", time: "09:48", impact: "긍정", url: "https://n.news.naver.com/mnews/article/015/0005122334" },
    { title: "1분기 영업이익 컨센서스 상회…메모리 회복 본격화", source: "매일경제", time: "어제", impact: "긍정", url: "https://n.news.naver.com/mnews/article/009/0005133445" },
  ],
  "000660": [
    { title: "SK하이닉스, HBM3E 12단 양산 본격화…수요 폭증", source: "전자신문", time: "14:01", impact: "긍정", url: "https://n.news.naver.com/mnews/article/030/0005241122" },
    { title: "엔비디아 차세대 GPU에 HBM4 단독 공급 협상 진행", source: "블룸버그", time: "10:33", impact: "긍정", url: "https://n.news.naver.com/mnews/article/025/0005252233" },
  ],
  "035420": [
    { title: "NAVER, AI 검색 '큐:' 정식 출시 임박", source: "ZDNet", time: "13:55", impact: "중립", url: "https://n.news.naver.com/mnews/article/092/0005311122" },
    { title: "1분기 광고 매출 부진…커머스는 두 자릿수 성장", source: "이데일리", time: "11:20", impact: "부정", url: "https://n.news.naver.com/mnews/article/018/0005322233" },
  ],
  "035720": [
    { title: "카카오, 콘텐츠 자회사 분할 검토 보도", source: "조선비즈", time: "14:22", impact: "부정", url: "https://n.news.naver.com/mnews/article/047/0005411122" },
    { title: "1분기 톡비즈 매출 둔화…광고 시장 침체 영향", source: "매일경제", time: "12:10", impact: "부정", url: "https://n.news.naver.com/mnews/article/009/0005422233" },
  ],
  "207940": [
    { title: "삼성바이오로직스, 5공장 가동 임박…매출 1조 추가", source: "한국경제", time: "13:40", impact: "긍정", url: "https://n.news.naver.com/mnews/article/015/0005511122" },
    { title: "글로벌 빅파마와 신규 CMO 계약 체결", source: "머니투데이", time: "10:55", impact: "긍정", url: "https://n.news.naver.com/mnews/article/008/0005522233" },
  ],
  "005380": [
    { title: "현대차·기아 4월 美 판매 14.2% 증가", source: "머니투데이", time: "10:24", impact: "긍정", url: "https://n.news.naver.com/mnews/article/008/0005567890" },
  ],
  "051910": [
    { title: "LG화학, 양극재 北美 증설 일부 연기", source: "전자신문", time: "13:11", impact: "부정", url: "https://n.news.naver.com/mnews/article/030/0005711122" },
  ],
  "373220": [
    { title: "LG에너지솔루션, 美 IRA 보조금 1.2조 확보", source: "한국경제", time: "14:50", impact: "긍정", url: "https://n.news.naver.com/mnews/article/015/0005811122" },
  ],
};

function generateCandles(code: string, base: number, n = 60): Candle[] {
  let seed = 0;
  ...
  for (let i = 0; i < n; i++) {
    ...
    candles.push({ open, close, high, low, volume, time });
    price = close;
  }
...
export const MOCK_CANDLES: Record<string, Candle[]> = Object.fromEntries(
  MOCK_WATCHLIST.map(s => [s.code, generateCandles(s.code, s.price)])
);

export const MOCK_TECHNICAL: Record<string, TechnicalAnalysis> = {
  "005930": {
    summary: "강한 매수", score: 78,
    signals: [
  ...
  "000660": {
    ...
    interpretation: "SK하이닉스는 HBM 수요 폭증 모멘텀으로 강한 상승 추세를 보이고 있습니다. 신규 진입보다는 보유 종목의 분할 익절을 권합니다.",
    levels: { support: 188000, resistance: 205000 },
  },
  "035420": {
    summary: "약한 매도", score: 38,
    signals: [
    ...
    interpretation: "NAVER는 광고 매출 부진과 외국인 매도세가 지속되며 기술적 지표 대부분이 약세를 가리키고 있습니다.",
  ...
  "035720": {
    ...
    interpretation: "카카오는 자회사 분할 이슈와 톡비즈 매출 둔화 우려로 기술적 지표 대부분이 약세입니다.",
  ...
  "207940": {
    ...
    interpretation: "삼성바이오로직스는 5공장 가동 모멘텀과 신규 CMO 계약 호재로 안정적 상승 흐름을 유지하고 있습니다.",
  ...
  "005380": {
    ...
    interpretation: "현대차는 美 판매 호조와 메타플랜트 가동 임박으로 펀더멘털과 기술적 지표가 모두 우호적입니다.",
    levels: { support: 244000, resistance: 258000 },
  },
  "051910": {
    summary: "약한 매도", score: 35,
    signals: [
    ...
    interpretation: "LG화학은 양극재 증설 연기 이슈와 중기 추세 약화로 기술적 지표가 부진합니다.",
  ...
  "373220": {
    ...
    interpretation: "LG에너지솔루션은 IRA 보조금 확보와 전고체 배터리 로드맵 공개로 투자 심리가 개선되고 있습니다.",
